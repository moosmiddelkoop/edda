...
We use the Pearson correlation test if the data is normally distributed and otherwise the Spearman test.
...
```
Pearson's returns the correlation value of 0.9908885 and Spearman's  p-value = 9.753e-06 herefore we conclude there exists a strong (positive) correlation between the two variables.
