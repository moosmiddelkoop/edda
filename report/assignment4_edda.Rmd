...
From this result we have enough evidence to reject hypotheses 1. and 2. but not 3. as we did not obtain a P-value lower than the significance level. Therefore we do not have enough evidence to conclude there to be significant interaction between the two factors. 

However, we conclude that there is a main effect of the two factors individually.
It was sensible to include the factor 'block', as 
```{r}
